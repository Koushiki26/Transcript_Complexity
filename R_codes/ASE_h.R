...
data1 <- read.table("as_h_A3_strict.ioe", header=T)
data2 <- read.table("as_h_A5_strict.ioe", header=T)
data3 <- read.table("as_h_AF_strict.ioe", header=T)
data4 <- read.table("as_h_AL_strict.ioe", header=T)
data5 <- read.table("as_h_MX_strict.ioe", header=T)
data6 <- read.table("as_h_RI_strict.ioe", header=T)
data7 <- read.table("as_h_SE_strict.ioe", header=T)
...
write.csv(data_lncRNA, file = "lncrna_ASE_h.csv", col.names = TRUE, row.names = F)
...
write.csv(data_CDS, file = "mrna_ASE_h.csv", col.names = TRUE, row.names = F)
