#plot of intron and exon length in mouse

data_lncRNA <- read.csv("lncRNA_length_m.csv", header = T)
head(data_lncRNA)
data_CDS <- read.csv("CDS_length_m.csv", header = T)
head(data_CDS)
...
par(mar=c(0,0,0,0))
tiff("/home/dell/Documents/koushiki/final_fig/fig_2b1.tiff",width = 1200, height = 1200, res = 400)
...
boxplot(a$intron_length/1000000, b$intron_length/1000000, col = c("#31A2AC","#3A5199"), xlab="",xaxt='n', ylab="", boxwex=0.9,
        at=c(1,2), outline=F, xlim=c(0,6), ylim=c(0,0.25), main="", cex.axis=1.6, font.axix=2)
...
tiff("/home/dell/Documents/koushiki/final_fig/fig_2b2.tiff",width = 1200, height = 1200, res = 400)
...
boxplot(a$exon_length/1000000, b$exon_length/1000000, col = c("#31A2AC","#3A5199"), xlab="",xaxt='n', ylab="", boxwex=0.9,
        at=c(1,2), outline=F, xlim=c(0,6), ylim=c(0,0.02), main="", cex.axis=1.6, font.axix=2)
