...
#scatterplot
tiff("/home/dell/Documents/koushiki/final_fig/supplementary_fig_1a2.tiff",width = 1200, height = 1200, res = 300)
par(mar=c(4,4,0.5,0.5))
plot(data_pcg$Transcript, data_pcg$Exon, xlim=c(0,25), ylim = c(0,400),
...
count(e1)
tiff("/home/dell/Documents/koushiki/final_fig/supplementary_fig_1b2.tiff",width = 1200, height = 1200, res = 300)
...
boxplot(a$Transcript, b$Transcript, c$Transcript, d$Transcript, e$Transcript,
        ...
        at=c(1,4,7,10,13), outline=F, xlim=c(0,15), ylim=c(0,25), main="")
