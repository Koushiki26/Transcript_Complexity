...
epg1 <- sum(data_lncRNA$Exon)/length(data_lncRNA$Gene)
epg2 <- sum(data_CDS$Exon)/length(data_CDS$Gene)
wilcox.test(data_lncRNA$Exon, data_CDS$Exon, alternative = "less")
ks.test(data_lncRNA$Exon, data_CDS$Exon, alternative = "two.sided")
...
epg_m1 <- sum(data_lncRNA1$Exon)/length(data_lncRNA1$Gene)
epg_m2 <- sum(data_CDS1$Exon)/length(data_CDS1$Gene)
wilcox.test(data_lncRNA1$Exon, data_CDS1$Exon, alternative = "less")
ks.test(data_lncRNA1$Exon, data_CDS1$Exon, alternative = "two.sided")
